...
from models.layers import BasicLayer, Mlp, RSTB, SwinTransformerBlock, WindowAttention
...
from quantization.quantizer import ActQuantizer, StraightThrough, UniformAffineQuantizer
...
class QuantRBWS(BaseQuantBlock):
    ...
    def __init__(
        self,
        basic_block: ResidualBlockWithStride,
        weight_quant_params: dict = {},
        act_quant_params: dict = {},
    ):
        super().__init__(act_quant_params)
        ...
        self.conv2 = QuantModule(
            basic_block.conv2, weight_quant_params, act_quant_params
        )
        ...
        if basic_block.skip is not None:
            self.skip = QuantModule(
                basic_block.skip, weight_quant_params, act_quant_params
            )
        else:
            self.skip = None
...
class QuantRBU(BaseQuantBlock):
    ...
    def __init__(
        self,
        basic_block: ResidualBlockUpsample,
        weight_quant_params: dict = {},
        act_quant_params: dict = {},
    ):
        super().__init__(act_quant_params)
...
class QuantWindowAttention(BaseQuantBlock):
    ...
    def __init__(
        ...
        self.relative_position_index = (
            basic_block.relative_position_index
        )  # whether True??
...
class QuantSwinTransformerBlock(BaseQuantBlock):
    ...
    def __init__(
        self,
        basic_block: SwinTransformerBlock,
        weight_quant_params: dict = {},
        act_quant_params: dict = {},
    ):
        super().__init__(act_quant_params)
        ...
        self.norm1 = QuantModule(
            basic_block.norm1, weight_quant_params, act_quant_params
        )
        self.attn = QuantWindowAttention(
            basic_block.attn, weight_quant_params, act_quant_params
        )
        # self.attn = basic_block.attn
        # self.drop_path = basic_block.drop_path
        # self.drop_path = nn.Identity()
        self.norm2 = QuantModule(
            basic_block.norm2, weight_quant_params, act_quant_params
        )
...
class QuantBasicLayer(BaseQuantBlock):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList(
            [
                QuantSwinTransformerBlock(
                    basic_block.blocks[i], weight_quant_params, act_quant_params
                )
...
class QuantRSTB(BaseQuantBlock):
    ...
    def __init__(
        ...
        self.residual_group = QuantBasicLayer(
            basic_block.residual_group, weight_quant_params, act_quant_params
        )
